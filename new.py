...
def blue_player_in_game():
    ...
    if blue_position + roll > 30:
        ...
        print(f"Blue skips turn because position over 30. Current position {blue_position}/30.")
...
def red_player_in_game():
    ...
    if red_position + roll > 30:
        ...
        print(f"Red skips turn because position over 30. Current position {red_position}/30.")
